  ...
  methods: {
    ...
    add () {
      this.$refs.addFormRef.validate(async valid => {
        ...
        // 处理动态参数
        this.manyTableTab.forEach(item => {
          const newInfo = {
        ...
        // 处理静态属性
        this.onlyTableTab.forEach(item => {
          const newInfo = {
            attr_id: item.attr_id,
